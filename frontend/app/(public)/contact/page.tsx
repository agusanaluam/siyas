...
export default function ContactPage() {
  ...
  const getMapEmbedUrl = (url: string | null | undefined): string => {
    if (!url) {
      return 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.687915886963!2d107.71372631477296!3d-6.927863994994468!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68c32a7e555555%3A0x5555555555555555!2sBandung!5e0!3m2!1sen!2sid!4v1620000000000!5m2!1sen!2sid'
    }
    ...
    // Jika URL Google Maps biasa, coba ekstrak place ID atau koordinat
    // Untuk sementara, jika bukan embed URL, tampilkan placeholder
    ...
    if (url.includes('maps.google.com') || url.includes('goo.gl/maps') || url.includes('maps.app.goo.gl')) {
      // Coba ekstrak place ID dari URL
      const placeIdMatch = url.match(/place\/([^/]+)/) || url.match(/@([^,]+),([^,]+)/)
      if (placeIdMatch) {
        // Jika ada koordinat, gunakan format embed dengan koordinat
        if (url.includes('@')) {
          const coordMatch = url.match(/@([^,]+),([^,]+)/)
          if (coordMatch) {
            return `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.687915886963!2d${coordMatch[2]}!3d${coordMatch[1]}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68c32a7e555555%3A0x5555555555555555!2sBandung!5e0!3m2!1sen!2sid!4v1620000000000!5m2!1sen!2sid`
          }
        }
      }
      // Jika tidak bisa dikonversi, return URL asli (akan error tapi lebih baik dari crash)
      return url
    }
          ...
          <div className="flex flex-col md:flex-row gap-12 mb-20">
            ...
            <div className="w-full md:w-1/2">
              <div className="bg-white p-2 rounded-xl shadow-lg h-[400px] relative">
                {setting?.gmaps && getMapEmbedUrl(setting.gmaps).includes('/maps/embed') ? (
                  <iframe 
