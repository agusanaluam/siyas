...
import { settingService } from '@/lib/api/settings'
  ...
  const fetchProfile = async () => {
    try {
      ...
      if (data && data.phone_number) {
        // Format phone number: remove non-digits, ensure it starts with country code (e.g., 62 for Indonesia)
        let formatted = data.phone_number.replace(/\D/g, '')
