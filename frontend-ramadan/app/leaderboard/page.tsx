    ...
    <div className="min-h-screen bg-ramadan-beige dark:bg-gray-900 pb-20">
      ...
      <main className="max-w-lg mx-auto px-4 py-4">
        <div className="text-center mb-4">
          <h1 className="text-xl font-bold text-ramadan-brown dark:text-white">Peringkat</h1>
          <p className="text-sm text-ramadan-brown/50 dark:text-gray-400 mt-1">
            Ramadhan 1447H / 2026
          </p>
        </div>
        ...
        {loading && leaderboard.length === 0 ? (
          <div className="card text-center py-8">
            <div className="animate-pulse text-ramadan-brown/50">Memuat peringkat...</div>
          </div>
        ) : (
